...
<div data-id="1" class="modal modal_sfera">
    <div class="modal__content">
        <div class="modal__close"></div>
        <div class="modal_sfera__wrp">
            <div class="modal_sfera__left">
                <div class="modal__title">Сельскохозяйственная техника 1</div>
                <div class="modal_sfera__links">
                    <a href="#" class="modal_sfera__link">Оцинкованный прокат</a>
                    <a href="#" class="modal_sfera__link">Трубы водогазопроводные</a>
                    <a href="#" class="modal_sfera__link">Трубы профильные оцинкованные</a>
                    <a href="#" class="modal_sfera__link">Сетка сварная арматурная</a>
                    <a href="#" class="modal_sfera__link">Сетка сварная</a>
                    <a href="#" class="modal_sfera__link">Сетка сварная арматурная</a>
                    <a href="#" class="modal_sfera__link">Лист холоднокатаный</a>
                </div>
            </div>
            <img class="modal_sfera__image" src="img/sfera__image-1.png" alt="">
        </div>
    </div>
</div>

<div data-id="2" class="modal modal_sfera">
    <div class="modal__content">
        <div class="modal__close"></div>
        <div class="modal_sfera__wrp">
            <div class="modal_sfera__left">
                <div class="modal__title">Сельскохозяйственная техника 2</div>
                <div class="modal_sfera__links">
                    <a href="#" class="modal_sfera__link">Оцинкованный прокат</a>
                    <a href="#" class="modal_sfera__link">Трубы водогазопроводные</a>
                    <a href="#" class="modal_sfera__link">Трубы профильные оцинкованные</a>
...
<div data-id="3" class="modal modal_sfera">
    <div class="modal__content">
        <div class="modal__close"></div>
        <div class="modal_sfera__wrp">
            <div class="modal_sfera__left">
                <div class="modal__title">Сельскохозяйственная техника 3</div>
                <div class="modal_sfera__links">
                    <a href="#" class="modal_sfera__link">Оцинкованный прокат</a>
                    <a href="#" class="modal_sfera__link">Трубы водогазопроводные</a>
                    <a href="#" class="modal_sfera__link">Трубы профильные оцинкованные</a>
...
<div data-id="4" class="modal modal_sfera">
    <div class="modal__content">
        <div class="modal__close"></div>
        <div class="modal_sfera__wrp">
            <div class="modal_sfera__left">
                <div class="modal__title">Сельскохозяйственная техника 4</div>
                <div class="modal_sfera__links">
                    <a href="#" class="modal_sfera__link">Оцинкованный прокат</a>
                    <a href="#" class="modal_sfera__link">Трубы водогазопроводные</a>
                    <a href="#" class="modal_sfera__link">Трубы профильные оцинкованные</a>
...
<div data-id="5" class="modal modal_sfera">
    <div class="modal__content">
        <div class="modal__close"></div>
        <div class="modal_sfera__wrp">
            <div class="modal_sfera__left">
                <div class="modal__title">Сельскохозяйственная техника 5</div>
                <div class="modal_sfera__links">
                    <a href="#" class="modal_sfera__link">Оцинкованный прокат</a>
                    <a href="#" class="modal_sfera__link">Трубы водогазопроводные</a>
                    <a href="#" class="modal_sfera__link">Трубы профильные оцинкованные</a>
...
<div data-id="6" class="modal modal_sfera">
    <div class="modal__content">
        <div class="modal__close"></div>
        <div class="modal_sfera__wrp">
            <div class="modal_sfera__left">
                <div class="modal__title">Сельскохозяйственная техника 6</div>
                <div class="modal_sfera__links">
                    <a href="#" class="modal_sfera__link">Оцинкованный прокат</a>
                    <a href="#" class="modal_sfera__link">Трубы водогазопроводные</a>
                    <a href="#" class="modal_sfera__link">Трубы профильные оцинкованные</a>
